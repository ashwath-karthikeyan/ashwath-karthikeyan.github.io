...
For a detailed look at how the math behind NAG works, please check out this [paper](https://github.com/ashwath-karthikeyan/nesterov/blob/master/docs/Nesterov_s_Accelerated_Gradient_Descent.pdf) detailing the method as well as the proof of the improved convergence rate.
